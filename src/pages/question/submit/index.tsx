...
import {BACKEND_HOST_LOCAL, BACKEND_HOST_PROD, WS_HOST_LOCAL} from "@/constants";
...
const SubmitPage: React.FC = () => {
  ...
  const [judgeStatus, setJudgeStatus] = useState<{
    status: 'idle' | 'judging' | 'success' | 'fail';
    message?: string
  }>({status: 'idle'});
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // TODO: 修改地址
      const wsHost = isDev ? WS_HOST_LOCAL : BACKEND_HOST_PROD;
      const wsUrl = `${wsHost}/api/ws/websocket/${sid}`;
